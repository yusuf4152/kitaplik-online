...
public class BookServiceApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Book book1 = new Book("dfsdfdsf","roman",2020,"reşat","ali","123");

		Book book2 = new Book("dfs","roman",2021,"reşat","ali","124");

		Book book3 = new Book("fdsf","roman",2022,"reşat","ali","125");
